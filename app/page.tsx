...
import { Coins, Trophy, Zap, Star, Target, User, LogOut } from "lucide-react"
            ...
            <Card className="relative overflow-hidden">
              ...
              <CardContent className="relative text-center space-y-4">
                ...
                <div className="grid grid-cols-2 gap-3 max-w-sm mx-auto">
                  ...
                  <Button size="lg" variant="secondary" onClick={() => setActiveGame("quick-click")} className="w-full">
                    Quick Click
                  </Button>
                </div>
              </CardContent>
              ...
              <CardContent className="space-y-3">
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex-1">
                    <p className="font-medium text-sm">CryptoKing</p>
                    <p className="text-xs text-muted-foreground">15,420 coins</p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex-1">
                    <p className="font-medium text-sm">GameMaster</p>
                    <p className="text-xs text-muted-foreground">12,890 coins</p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex-1">
                    <p className="font-medium text-sm">ProPlayer</p>
                    <p className="text-xs text-muted-foreground">11,250 coins</p>
                  </div>
                </div>
